package com.sudnu.plugin_base.plugin_view
...
object PluginLoadAar {
    ...
    fun loadPluginApk(context: Context) {
        var plugin = Environment.getExternalStorageDirectory().absolutePath+ File.separator+"plugin/out.apk"
