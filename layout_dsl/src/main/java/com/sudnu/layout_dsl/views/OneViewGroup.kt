package com.sudnu.layout_dsl.views
...
import com.sudnu.layout_dsl.dsl.dp
import com.sudnu.layout_dsl.dsl.parent_id
import com.sudnu.layout_dsl.dsl.sp
import com.sudnu.layout_dsl.dsl.toLayoutId
 ...
 */
class ImageDrawable @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : AppCompatImageView(context, attrs, defStyleAttr),
    OneViewGroup.Drawable {
